...
//            musicGrid.getChildren().addAll();
            ...
            try
            {
                Image screen1Image = new Image(new FileInputStream("C:\\Users\\poity\\Downloads\\cryptovibe\\cryptovibe\\cryptovibelogo.png"));
                boxmaterial1.setDiffuseMap(screen1Image);
                Image screen2Image = new Image(new FileInputStream("C:\\Users\\poity\\Downloads\\cryptovibe\\cryptovibe\\screenBorder.png"));
                boxmaterial2.setDiffuseMap(screen2Image);
                Image musicButtonImage = new Image(new FileInputStream("C:\\Users\\poity\\Downloads\\cryptovibe\\cryptovibe\\button.png"));
                musicButtonmaterial.setDiffuseMap(musicButtonImage);
                Image chartScreenImage = new Image(new FileInputStream("C:\\Users\\poity\\Downloads\\cryptovibe\\cryptovibe\\chartScreen.png"));
                chartScreenmaterial.setDiffuseMap(chartScreenImage);
                Image scrollButtonImage = new Image(new FileInputStream("C:\\Users\\poity\\Downloads\\cryptovibe\\cryptovibe\\scrollButton.png"));
                scrollButtonmaterial.setDiffuseMap(scrollButtonImage);
                Image transactionScreenImage = new Image(new FileInputStream("C:\\Users\\poity\\Downloads\\cryptovibe\\cryptovibe\\transactionScreen.png"));
                transactionScreenmaterial.setDiffuseMap(transactionScreenImage);
                Image playButtonImage = new Image(new FileInputStream("C:\\Users\\poity\\Downloads\\cryptovibe\\cryptovibe\\playButton.png"));
                playButtonmaterial.setDiffuseMap(playButtonImage);
                Image plusButtonImage = new Image(new FileInputStream("C:\\Users\\poity\\Downloads\\cryptovibe\\cryptovibe\\plusButton.png"));
                plusbuttonmaterial.setDiffuseMap(plusButtonImage);
                Image subtractButtonImage = new Image(new FileInputStream("C:\\Users\\poity\\Downloads\\cryptovibe\\cryptovibe\\minusButton.png"));
                subtractbuttonmaterial.setDiffuseMap(subtractButtonImage);
                Image gobackButtonImage = new Image(new FileInputStream("C:\\Users\\poity\\Downloads\\cryptovibe\\cryptovibe\\gobackButton.png"));
                goBackButtonmaterial.setDiffuseMap(gobackButtonImage);
                Image skipnextButtonImage = new Image(new FileInputStream("C:\\Users\\poity\\Downloads\\cryptovibe\\cryptovibe\\skipnextButton.png"));
                skipNextButtonmaterial.setDiffuseMap(skipnextButtonImage);
                Image loopButtonImage = new Image(new FileInputStream("C:\\Users\\poity\\Downloads\\cryptovibe\\cryptovibe\\loopButton.png"));
                loopButtonmaterial.setDiffuseMap(loopButtonImage);
                Image shuffleButtonImage = new Image(new FileInputStream("C:\\Users\\poity\\Downloads\\cryptovibe\\cryptovibe\\shuffleButton.png"));
                shuffleButtonmaterial.setDiffuseMap(shuffleButtonImage);
                Image buyButtonImage = new Image(new FileInputStream("C:\\Users\\poity\\Downloads\\cryptovibe\\cryptovibe\\buyButton.png"));
                buyButtonmaterial.setDiffuseMap(buyButtonImage);
                Image sellButtonImage = new Image(new FileInputStream("C:\\Users\\poity\\Downloads\\cryptovibe\\cryptovibe\\sellButton.png"));
                sellButtonmaterial.setDiffuseMap(sellButtonImage);
                sellButtonmaterial.setDiffuseMap(sellButtonImage);
                Image playerscreenImage = new Image(new FileInputStream("C:\\Users\\poity\\Downloads\\cryptovibe\\cryptovibe\\nftplayerScreen.png"));
                playerscreenmaterial.setDiffuseMap(playerscreenImage);
                Image nftexampleImage = new Image(new FileInputStream("C:\\Users\\poity\\Downloads\\cryptovibe\\cryptovibe\\nftExample.png"));
            ...
            queueListText1.setOnMouseClicked(event -> {
                for(int i = 0; i < pianoTextArr.length; i++)
                {
                    ...
                    {
                        pianoTextArr[i].setText(pianoArr.get(0));
                        pianoholderArr.set(pianoCount, pianoArr.get(0));
                        pianoCount++;
                        break;
                    }
                }
            ...
            queueListText2.setOnMouseClicked(event -> {
                for(int i = 0; i < pianoTextArr.length; i++)
                {
                    ...
                    if(pianoTextArr[i].getText().equals(""))
                    {
                        pianoTextArr[i].setText(pianoArr.get(1));
                        pianoholderArr.set(pianoCount, pianoArr.get(1));
                        pianoCount++;
                        break;
                    }
                }
            ...
            queueListText3.setOnMouseClicked(event -> {
                for(int i = 0; i < pianoTextArr.length; i++)
                {
                    ...
                    if(pianoTextArr[i].getText().equals(""))
                    {
                        pianoTextArr[i].setText(pianoArr.get(2));
                        pianoholderArr.set(pianoCount, pianoArr.get(2));
                        pianoCount++;
                        break;
                    }
                }
            ...
            queueListText4.setOnMouseClicked(event -> {
                for(int i = 0; i < pianoTextArr.length; i++)
                {
                    ...
                    if(pianoTextArr[i].getText().equals(""))
                    {
                        pianoTextArr[i].setText(pianoArr.get(3));
                        pianoholderArr.set(pianoCount, pianoArr.get(3));
                        pianoCount++;
                        break;
                    }
                }
            ...
            queueListText5.setOnMouseClicked(event -> {
                for(int i = 0; i < pianoTextArr.length; i++)
                {
                    ...
                    if(pianoTextArr[i].getText().equals(""))
                    {
                        pianoTextArr[i].setText(pianoArr.get(4));
                        pianoholderArr.set(pianoCount, pianoArr.get(4));
                        pianoCount++;
                        break;
                    }
                }
            ...
            queueListText6.setOnMouseClicked(event -> {
                for(int i = 0; i < pianoTextArr.length; i++)
                {
                    ...
                    if(pianoTextArr[i].getText().equals(""))
                    {
                        pianoTextArr[i].setText(pianoArr.get(5));
                        pianoholderArr.set(pianoCount, pianoArr.get(5));
                        pianoCount++;
                        break;
                    }
                }
            ...
            queueListText7.setOnMouseClicked(event -> {
                for(int i = 0; i < pianoTextArr.length; i++)
                {
                    ...
                    if(pianoTextArr[i].getText().equals(""))
                    {
                        pianoTextArr[i].setText(pianoArr.get(6));
                        pianoholderArr.set(pianoCount, pianoArr.get(6));
                        pianoCount++;
                        break;
                    }
                }
            ...
            queueListText8.setOnMouseClicked(event -> {
                for(int i = 0; i < pianoTextArr.length; i++)
                {
                    ...
                    if(pianoTextArr[i].getText().equals(""))
                    {
                        pianoTextArr[i].setText(pianoArr.get(7));
                        pianoholderArr.set(pianoCount, pianoArr.get(7));
                        pianoCount++;
                        break;
                    }
                }
            ...
            queueListText9.setOnMouseClicked(event -> {
                for(int i = 0; i < pianoTextArr.length; i++)
                {
                    ...
                    if(pianoTextArr[i].getText().equals(""))
                    {
                        pianoTextArr[i].setText(pianoArr.get(8));
                        pianoholderArr.set(pianoCount, pianoArr.get(8));
                        pianoCount++;
                        break;
                    }
                }
            ...
            queueListText10.setOnMouseClicked(event -> {
                for(int i = 0; i < pianoTextArr.length; i++)
                {
                    ...
                    if(pianoTextArr[i].getText().equals(""))
                    {
                        pianoTextArr[i].setText(pianoArr.get(9));
                        pianoholderArr.set(pianoCount, pianoArr.get(9));
                        pianoCount++;
                        break;
                    }
                }
            ...
            queueListText11.setOnMouseClicked(event -> {
                for(int i = 0; i < pianoTextArr.length; i++)
                {
                    ...
                    if(pianoTextArr[i].getText().equals(""))
                    {
                        pianoTextArr[i].setText(pianoArr.get(10));
                        pianoholderArr.set(pianoCount, pianoArr.get(10));
                        pianoCount++;
                        break;
                    }
                }
            ...
            queueListText12.setOnMouseClicked(event -> {
                for(int i = 0; i < pianoTextArr.length; i++)
                {
                    ...
                    if(pianoTextArr[i].getText().equals(""))
                    {
                        pianoTextArr[i].setText(pianoArr.get(11));
                        pianoholderArr.set(pianoCount, pianoArr.get(11));
                        pianoCount++;
                        break;
                    }
                }
...
//            boxes.getChildren().addAll(plusButton,subtractButton);
            ...
            goDownArrow2.setOnMouseClicked(event -> {
                if(musicHolder12+scrollCounter<14) {
                    scrollCounter++;
                    queueListText1.setText(pianoArr.get(musicHolder1 + scrollCounter));
                    queueListText2.setText(pianoArr.get(musicHolder2 + scrollCounter));
                    queueListText3.setText(pianoArr.get(musicHolder3 + scrollCounter));
...
//        rotateCamera.getTransforms().setAll(pointLight.getTransforms());
        ...
        //image
        Image soliImage = new Image(new FileInputStream("C:\\Users\\poity\\Downloads\\cryptovibe\\cryptovibe\\screenBorder.png"));
        ImageView imageView = new ImageView(soliImage);
        Group imageRoot = new Group(imageView);
        imageView.setFocusTraversable(true);

        //background Image
        Image spaceBackgroundImage = new Image(new FileInputStream("C:\\Users\\poity\\Downloads\\cryptovibe\\cryptovibe\\screenBorder.png"));
