...
public class GuitarTrackRunnable implements Runnable
{
    ...
    public void playSoundFX(String currentSound) {
        String basePath = "C:\\Users\\poity\\Downloads\\cryptovibe\\cryptovibe\\cryptovibeSound\\Sound Files\\Guitar Chords\\"; // Replace with the base path to your sound files
        switch (currentSound) {
            case "GMajor":
